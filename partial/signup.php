    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="signupLabel">sign up to create an iDiscuss account</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="partial/_handle.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <small id="emailHelp" class="form-text text-muted">Password and confirm password should be
                            matched..!!</small>
                    </div>
